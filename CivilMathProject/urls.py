...
urlpatterns = patterns('',
    ...
    url(r'^Home/.*/CalculateFormula1/$','CivilMathProject.views.CalculateFormula1',name='CalculateFormula1'),
    url(r'^Home/.*/CalculateFormula2/$','CivilMathProject.views.CalculateFormula2',name='CalculateFormula2'),
